"""
Train Bayesian MPO on polynomial and visualize predictions.

This script:
1. Trains a Bayesian MPO on polynomial data
2. Plots predicted mean vs true polynomial
3. Plots predicted variance (epistemic uncertainty)
4. Shows training data points
5. Displays confidence intervals
"""
...
print("="*70)
print("BAYESIAN MPO POLYNOMIAL PREDICTION VISUALIZATION")
print("="*70)
print()
...
# Create Bayesian MPO with automatic trimming
print("Creating Bayesian MPO (rank=8, auto-trim at 10)...")
...
print("Training for 30 iterations with auto-trim threshold=10...")
print()
...
for iteration in range(max_iter):
    ...
    # Apply trimming
    thresholds = {'r1': 10.0, 'r2': 10.0}
    n_kept = {}
    for label in ['r1', 'r2']:
        exp = bmpo.mu_mpo.distributions[label]['expectation']
        n_kept[label] = (exp >= 10.0).sum().item()
...
ax1.set_title('Bayesian MPO Predictions with Uncertainty', fontsize=14, fontweight='bold')
...
print("Plot saved to: bayesian_predictions.png")
print()
